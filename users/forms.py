...
class PasswordsChangeForm(PasswordChangeForm):
    old_password=forms.CharField(max_length=100,widget=forms.PasswordInput(attrs={'class':'form-control', 'type':'password','label':'Contraseña'}))
...
class ProfilePageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'pin_url':forms.TextInput(attrs={'class':'form-control'}),
    }